...
#ifndef NationData_h__
#define NationData_h__
...
// This file (temporarily) holds all nation specific data that is not yet moved to lua

// Deprecated. To be removed ASAP
#define OLD_NUM_NATS 5

/// Convert shield to roman shield, returns the same for every other good
...
const boost::array<GoodType, OLD_NUM_NATS> SUPPRESS_UNUSED SHIELD_TYPES = {
  {GD_SHIELDAFRICANS, GD_SHIELDJAPANESE, GD_SHIELDROMANS, GD_SHIELDVIKINGS, GD_SHIELDJAPANESE}};

/// Positions of the 3 donkey in the donkey breeder
const helpers::SimpleMultiArray<PositionPtInit, OLD_NUM_NATS, 3> SUPPRESS_UNUSED DONKEY_OFFSETS = {{{{13, -9}, {26, -9}, {39, -9}},
                                                                                                    {{3, -17}, {16, -17}, {30, -17}},
                                                                                                    {{2, -21}, {15, -21}, {29, -21}},
                                                                                                    {{7, -17}, {18, -17}, {30, -17}},
                                                                                                    {{3, -22}, {16, -22}, {30, -22}}}};

/// Positions of the 5 pigs per nation (1st is big pig)
const helpers::SimpleMultiArray<PositionPtInit, OLD_NUM_NATS, 5> SUPPRESS_UNUSED PIG_POSITIONS = {{
...
/// Work position of the armorer
const boost::array<PositionPtInit, OLD_NUM_NATS> SUPPRESS_UNUSED ARMORER_POS = {{{-10, 15}, {-11, 9}, {-14, 16}, {-19, 1}, {-11, 9}}};

/// Offset of the troop flag per nation and type from the buildings origin
const helpers::SimpleMultiArray<PositionPtInit, OLD_NUM_NATS, 4> SUPPRESS_UNUSED TROOPS_FLAG_OFFSET = {
...
const helpers::SimpleMultiArray<PositionPtInit, OLD_NUM_NATS, 4> SUPPRESS_UNUSED BORDER_FLAG_OFFSET = {
...
const boost::array<PositionPtInit, OLD_NUM_NATS> TROOPS_FLAG_HQ_OFFSET = {{{-12, -102}, {-19, -94}, {-18, -112}, {20, -54}, {-33, -81}}};
...
/// Animations for every nation, all ranks and both directions
const FightAnimation FIGHT_ANIMATIONS[OLD_NUM_NATS][5][2] = {
  // Nubier
  {// Schütze (Rang 1)
...
const unsigned short HIT_SOLDIERS[OLD_NUM_NATS][5] = {{1556, 1558, 1560, 1562, 1564},
                                                      {1143, 1145, 1147, 1149, 1147},
                                                      {895, 897, 899, 901, 899},
                                                      {1372, 1374, 1376, 1378, 1380},
                                                      {1143, 1145, 1147, 1149, 1147}};

/// Frame number at which the victim blinks (per rank)
