iconFile = "<RTTR_GAME>/DATA/MBOB/JAP_ICON.LST.LST"
...
nation:AddBuilding{
	...
	texture = { main = {{"charburner", 9}, {"charburner", 14}}, shadow = {"charburner", 10}, skeleton = {"charburner", 11}, skeletonShadow = {"charburner", 12}, door = {{"charburner", 13}, {"charburner", 15}} },
	doorPosY = 0,
...
nation:AddBuilding{
	...
	animations = {
		occupied = { filepath = "<Japanese>", frames = range(500, 540, 5), msPerFrame = 158 },
