iconFile = "<RTTR_RTTR>/LSTS/GAME/Babylonier/bab_icon.lst"
...
nation:AddBuilding{
	...
	doorPosY = 7,
	smoke = { type = 2, offset = {-23, -36} }
}
nation:AddBuilding{
	name = "Charburner",
	icon = { filepath = "charburner", idx = 40 },
	texture = { main = {{"charburner", 33}, {"charburner", 38}}, shadow = {"charburner", 34}, skeleton = {"charburner", 35}, skeletonShadow = {"charburner", 36}, door = {{"charburner", 37}, {"charburner", 39}} },
	doorPosY = 0
}
nation:AddBuilding{
	name = "Pig farm",
...
nation:AddBuilding{
	...
	animations = {
		occupied = { filepath = "<Babylonians>", frames = range(500, 540, 5), msPerFrame = 158 },
		work = { filepath = "<Map>", frames = range(740, 748), offset = {0, 0}, msPerFrame = 197 }
	},
	workOffsets = {
		builder = {-38, 17},
		boards = {-65, -5},
