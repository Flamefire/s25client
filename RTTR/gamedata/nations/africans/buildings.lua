iconFile = "<RTTR_GAME>/DATA/MBOB/AFR_ICON.LST"
...
nation:AddBuilding{
	...
	texture = { main = {{"charburner", 1}, {"charburner", 6}}, shadow = {"charburner", 2}, skeleton = {"charburner", 3}, skeletonShadow = {"charburner", 4}, door = {{"charburner", 5}, {"charburner", 7}} },
	doorPosY = 0,
