iconFile = "<RTTR_GAME>/DATA/MBOB/ROM_ICON"
...
nation:AddBuilding{
	...
	doorPosY = 16,
	smoke = { type = 1, offset = {-16, -34} }
}
nation:AddBuilding{
	name = "Charburner",
	icon = { filepath = "charburner", idx = 24 },
	texture = { main = {{"charburner", 17}, {"charburner", 22}}, shadow = {"charburner", 18}, skeleton = {"charburner", 19}, skeletonShadow = {"charburner", 20}, door = {{"charburner", 21}, {"charburner", 23}} },
	doorPosY = 0,
	smoke = { type = 2, offset = {-36, -38} }
}
nation:AddBuilding{
	name = "Pig farm",
...
nation:AddBuilding{
	...
	animations = {
		occupied = { filepath = "<Romans>", frames = range(500, 540, 5), msPerFrame = 158 },
